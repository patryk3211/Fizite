...
//            }
            ...
            if(consoleOut) {
                ...
                System.out.println("    forceApply = " + (world.forceApplyTime / 1000.0) + "us");
                System.out.println("    total = " + ((world.constraintSolveTime + world.physicsStepTime + world.physicsSolveTime + world.forceApplyTime) / 1000.0) + "us");
