...
//        XY
    ...
    public static Constraint makeConnection(ConnectionType type, RigidBody body1, RigidBody body2, Vector2f anchor1, Vector2f anchor2) {
...
//        }
        ...
        return switch(type) {
            ...
            case BEARING -> new BearingConstraint(body1, body2, anchor1.x, anchor1.y, anchor2.x, anchor2.y);
            case ROTATION -> new RotationConstraint(body1, body2);
